...
public:
  ClassDecl(void) : M_action_count(0) { }
  ClassDecl(std::string const& name) : M_name(name), M_action_count(0) { }
  ClassDecl(std::string const& name, std::string const& template_argument_list) :
      M_name(name), M_template_argument_list_opt(template_argument_list), M_action_count(0) { }
